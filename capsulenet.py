...
from utils1 import combine_images
...
def load_mnist():
    ...
    x_train = x_train.reshape(x_train.shape[0], 128, 128, 3).astype('float32') / 255
    x_test = x_test.reshape(x_test.shape[0], 128, 128, 3).astype('float32') / 255
